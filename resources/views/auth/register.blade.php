...
<body>
	<div class="container h-100">
		<div class="d-flex justify-content-center h-100" style="padding-top:5em;">
			<div class="user_card" style="width: 80%;">
				...
				<div class="d-flex justify-content-center form_container">
                    ...
                    @csrf                    
						<div class="input-group mb-2">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"         value="{{ old('name') }}" placeholder="Nombre completo">                            
						</div>
                        @error('name')
						...
						<div class="form-group">
                            ...
                            <div class="icheck-primary">
                                <a href="{{ route('login') }}" class="text-center">Ya tengo un usuario registrado</a>
                            </div>                            
						</div>
