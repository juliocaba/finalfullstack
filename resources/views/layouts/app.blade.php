...
<head>
    ...
    <link rel="stylesheet"
          ...
          crossorigin="anonymous"/>
    <!-- Bootstrap 4.1.1 ACA ARRANCA LO QUE AGREGUE -->
    ...
    <!-- Duallistbox  ACA TERMINA -->
    <link rel="stylesheet" href="{{ asset('assets/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.css') }}">
